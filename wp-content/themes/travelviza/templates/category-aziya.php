...
/*
Template Name:  шаблон поста азия
...
<section class=" container d-flex">
	...
	<div class="aziya-bg__left position-absolute ">
		<img src="/wp-content/uploads/2023/12/fon-sboku-1.png" alt="">
	</div>
</section>
...
// $thumbnail_id = carbon_get_post_meta(get_the_ID(), 'card-foto');
